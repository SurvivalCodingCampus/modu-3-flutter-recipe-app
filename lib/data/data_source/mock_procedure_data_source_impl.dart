...
class MockProcedureDataSourceImpl implements ProcedureDataSource {
  ...
  ''';
  @override
  Future<List<ProcedureDto>> getProcedures() async {
    final List decodedData = jsonDecode(_mockData);
    final result = decodedData.map((e) => e as Map<String, dynamic>).toList();
    return result.map((e) => ProcedureDto.fromJson(e)).toList();
  }
}

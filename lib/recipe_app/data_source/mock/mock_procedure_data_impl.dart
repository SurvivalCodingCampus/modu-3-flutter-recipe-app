...
import 'package:recipe_app/recipe_app/data/mapper/procedure_mapper.dart';
...
class MockRecipeDataImpl implements ProcedureDataSource {
  ...
  Future<List<Procedure>> getProcedureData() async {
    ...
    List<dynamic> jsonList = json['procedures'];
    return jsonList
...
final mockProcedures = {
  "procedures": [
    {"recipeId": 1, "step": 1, "content": "Preheat the oven to 350°F (175°C)."},
    {
      "recipeId": 1,
      "step": 2,
      "content":

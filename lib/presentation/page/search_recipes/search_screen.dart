...
import 'filter_search/filter_search_screen.dart';
import 'filter_search/filter_search_view_model.dart';
...
class _SearchScreenState extends State<SearchScreen> {
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) {
      widget.onAction(SearchRecipesAction.onPageLoadGetData());
    });
  }
  ...
  void _onTextChanged() async {
    ...
    _debounce = Timer(const Duration(milliseconds: 500), () async {
      widget.onAction(SearchRecipesAction.onSearchRecipe(_controller.text));
    });
  }
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
                ...
                child: Stack(
                  ...
                  children: [
                    Align(
                      ...
                      child: IconButton(
                        onPressed: () {
                          context.pop(widget.state.filterRecipes);
                        },
                  ...
                  InkWell(
                    onTap: () {
                      showModalBottomSheet(
                        ...
                        widget.onAction(
                          SearchRecipesAction.onFilterSearchRecipes(value),
                        );
                      });
                    },
                    borderRadius: BorderRadius.circular(10),
              ...
              SizedBox(height: 20),
              Text(
                widget.state.searchKeyWord.isEmpty
                    ? 'Recent '
                        'Search'
                    : 'Search Result',
              ...
              Expanded(
                child: GridView.count(
                  ...
                  crossAxisSpacing: 15,
                  children:
                      widget.state.filterRecipes.isEmpty
                          ? widget.state.recipes.map((items) {
                          ...
                          : widget.state.filterRecipes.map((items) {
                            return RecipeSearchCard(
                              recipeName: items.name,
                              recipeAuthor: items.author,
                              imagePath: items.image,

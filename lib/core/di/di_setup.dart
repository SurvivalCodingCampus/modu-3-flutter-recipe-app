...
import 'package:recipe_app/data/repository/mock_recent_search_repository_impl.dart';
import 'package:recipe_app/data/repository/mock_setting_repository_impl.dart';
...
void diSetup() {
  ...
  getIt.registerSingleton<SettingRepository>(MockSettingRepositoryImpl(isErrorSituation: true));
  getIt.registerSingleton<RecentSearchRepository>(MockRecentSearchRepositoryImpl());
  ...
  getIt.registerSingleton(SearchRecipesUseCase(recentSearchRepository: getIt()));
